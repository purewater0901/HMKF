                                                    ...
                                                    const Eigen::Vector2d& landmark)
{
    ...
    const double xPow1_yPow2_cPow3_sPow1 = dist.calc_xy_cos_z_sin_z_moment(1, 2, 3, 1);
    const double xPow2_yPow1_cPow4 = dist.calc_xy_cos_z_sin_z_moment(2, 1, 4, 0);
    const double xPow2_yPow1_sPow4 = dist.calc_xy_cos_z_sin_z_moment(2, 1, 0, 4);
    const double xPow1_yPow2_cPow4 = dist.calc_xy_cos_z_sin_z_moment(1, 2, 4, 0);
    const double xPow1_yPow2_sPow4 = dist.calc_xy_cos_z_sin_z_moment(1, 2, 0, 4);

    const double xPow4_cPow4 = dist.calc_xy_cos_y_sin_y_moment(STATE::IDX::X, STATE::IDX::YAW, 4, 0, 4, 0);
    const double xPow4_sPow4 = dist.calc_xy_cos_y_sin_y_moment(STATE::IDX::X, STATE::IDX::YAW, 4, 0, 0, 4);
    ...
    const double xPow3_yPow1_cPow4 = dist.calc_xy_cos_z_sin_z_moment(3, 1, 4, 0);
    const double xPow1_yPow3_cPow4 = dist.calc_xy_cos_z_sin_z_moment(1, 3, 4, 0);
    const double xPow3_yPow1_sPow4 = dist.calc_xy_cos_z_sin_z_moment(3, 1, 0, 4);
    const double xPow1_yPow3_sPow4 = dist.calc_xy_cos_z_sin_z_moment(1, 3, 0, 4);
    const double xPow2_yPow2_cPow4 = dist.calc_xy_cos_z_sin_z_moment(2, 2, 4, 0);
    const double xPow2_yPow2_sPow4 = dist.calc_xy_cos_z_sin_z_moment(2, 2, 0, 4);
    const double xPow2_yPow2_cPow3_sPow1 = dist.calc_xy_cos_z_sin_z_moment(2, 2, 3, 1);
    const double xPow2_yPow2_cPow1_sPow3 = dist.calc_xy_cos_z_sin_z_moment(2, 2, 1, 3);
    const double xPow1_yPow3_cPow3_sPow1 = dist.calc_xy_cos_z_sin_z_moment(1, 3, 3, 1);
    const double xPow3_yPow1_cPow1_sPow3 = dist.calc_xy_cos_z_sin_z_moment(3, 1, 1, 3);
    const double xPow1_yPow3_cPow2_sPow2 = dist.calc_xy_cos_z_sin_z_moment(1, 3, 2, 2);
    const double xPow3_yPow1_cPow2_sPow2 = dist.calc_xy_cos_z_sin_z_moment(3, 1, 2, 2);
